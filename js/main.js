{
  ...
  btn.addEventListener('click', () => {
    const popupIndex = btn.dataset.popup;
    const targetItem = document.querySelector(`.grid__item[data-popup="${popupIndex}"]`);
    if (!targetItem) return;

    const productBg = targetItem.querySelector('.product__bg');
    const description = targetItem.querySelector('.product__description');
